...
class BootStrap {    
    ...
    def init = { servletContext ->
       ...
       if (entities.Component.count()==0) {
           ...
           def coreQ = new entities.Component(name:"CoreQueries", appVersion:"1.0", baseURL:"http://localhost:9081/CoreQueries").save()
           def coreU = new entities.Component(name:"CoreUpdates", appVersion:"1.0", baseURL:"http://localhost:9082/CoreQUpdates").save()
